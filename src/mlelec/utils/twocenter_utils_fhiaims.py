...
def to_coupled_blocks(matrices, frames, orbs):
    q= {}
    for s in matrices.keys():
        q[tuple(s)] = _to_coupled_basis(_matrix_to_blocks(matrices[tuple(s)], frames=frames, orbitals=orbs,), orbs) # uncouple -> coupled    
    return q
