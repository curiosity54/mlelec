...
def plot_hamiltonian(matrix, plot_abs = False, write_values = True, plot_structure = False, structure = None, tick_labels = None):
# TODO: Support passing ticklabels or generate tick labels given basis set and structure 
    ...
    if tick_labels is not None:
        ...
        ax.set_xticklabels(['1s','2s','2py','2pz','2px','1s','2s','2py','2pz','2px'])
        ax.set_yticklabels(['1s','2s','2py','2pz','2px','1s','2s','2py','2pz','2px'])
